                  ...
                  <SectionStack>
                    ...
                    <SectionGrid>
                      ...
                      <FieldAnchor fieldId="rmPanelRepo">
                        {/* FORK[branding]: default management updates to this fork's release feed. */}
                        <Input
                          label={t('config_management.visual.sections.remote.panel_repo')}
                          placeholder="https://github.com/Z-M-Huang/Cli-Proxy-API-Management-Center"
              ...
              <SectionStack>
                ...
                >
                  <SectionStack>
                    ...
                    <Divider />
                    <SectionGrid>
                      <FieldAnchor fieldId="geminiHeaderUserAgent">
                        <Input
                          label={t('config_management.visual.sections.headers.gemini_user_agent')}
                          placeholder="custom-gemini-client/1.0"
                          value={values.geminiHeaderUserAgent}
                          onChange={(e) => onChange({ geminiHeaderUserAgent: e.target.value })}
                          disabled={disabled}
                          hint={t(
                            'config_management.visual.sections.headers.gemini_user_agent_hint'
                          )}
                        />
                      </FieldAnchor>
                      <FieldAnchor fieldId="openAICompatHeaderUserAgent">
                        <Input
                          label={t(
                            'config_management.visual.sections.headers.openai_compat_user_agent'
                          )}
                          placeholder="cli-proxy-openai-compat"
                          value={values.openAICompatHeaderUserAgent}
                          onChange={(e) =>
                            onChange({ openAICompatHeaderUserAgent: e.target.value })
                          }
                          disabled={disabled}
                          hint={t(
                            'config_management.visual.sections.headers.openai_compat_user_agent_hint'
                          )}
                        />
                      </FieldAnchor>
                      <FieldAnchor fieldId="kimiHeaderUserAgent">
                        <Input
                      ...
                      <FieldAnchor fieldId="antigravityHeaderUserAgent">
                        <Input
                          label={t(
                            'config_management.visual.sections.headers.antigravity_user_agent'
                          )}
                          ...
                          disabled={disabled}
                          hint={t(
                            'config_management.visual.sections.headers.antigravity_user_agent_hint'
                          )}
                        />
                      </FieldAnchor>
                    </SectionGrid>
