...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  {
    // FORK[provider-headers]: expose backend-fork defaults through upstream config search.
    fieldId: 'geminiHeaderUserAgent',
    sectionId: 'advanced',
    labelKey: L('sections.headers.gemini_user_agent'),
    yamlKeys: ['gemini-header-defaults', 'gemini-cli-header-defaults', 'user-agent'],
    keywords: ['gemini'],
  },
  {
    fieldId: 'openAICompatHeaderUserAgent',
    sectionId: 'advanced',
    labelKey: L('sections.headers.openai_compat_user_agent'),
    yamlKeys: ['openai-compatibility-header-defaults', 'user-agent'],
    keywords: ['openai', 'compatibility'],
  },
  {
    fieldId: 'kimiHeaderUserAgent',
    sectionId: 'advanced',
    labelKey: L('sections.headers.kimi_user_agent'),
    yamlKeys: ['kimi-header-defaults', 'user-agent'],
    keywords: ['kimi'],
  },
  {
    fieldId: 'antigravityHeaderUserAgent',
    sectionId: 'advanced',
    labelKey: L('sections.headers.antigravity_user_agent'),
    yamlKeys: ['antigravity-header-defaults', 'user-agent'],
