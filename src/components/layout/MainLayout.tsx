  ...
  const navGroups: SidebarNavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          // FORK[usage]: persisted analytics remains visible beside upstream observability pages.
          path: '/usage',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          path: '/prompt-rules',
          labelKey: 'nav.prompt_rules',
          metaKey: 'nav_meta.prompt_rules',
          icon: sidebarIcons.promptRules,
        },
        ...(supportsPlugin
          ? [
              {
