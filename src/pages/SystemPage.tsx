      ...
      <div className={styles.content}>
        ...
        <Card title={t('system_info.quick_links_title')}>
          ...
          <div className={styles.quickLinks}>
            {/* FORK[branding]: repository cards target the paired fork sources. */}
            <a
              href="https://github.com/Z-M-Huang/CLIProxyAPI"
              target="_blank"
            ...
            <a
              href="https://github.com/Z-M-Huang/Cli-Proxy-API-Management-Center"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.linkCard}
            >
